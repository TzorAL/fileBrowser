...
<table><tr><th colspan="1" rowspan="4"></th><th colspan="1"></th><th colspan="1" valign="top">this opens a <i>modal box</i> containing a textfield which initially has the old name of the file or directory. The user can edit it and save the file or directory with the new name.</th></tr>
